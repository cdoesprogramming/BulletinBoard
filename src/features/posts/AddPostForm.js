...
const AddPostForm = () => {
    ...
    // The two variables below use the setTitle and setContent to get the event target value
    ...
    // The value is the user id. We will grab the user id through our onAuthorChanged variable that sets the userid
    // on line 12. Then we send the userid state to the postAdded function on line 24.
